...
def migrate_secret_key(source: os.PathLike[str], target: os.PathLike[str]) -> bool:
    ...
    os.makedirs(target_parent, mode=448, exist_ok=True)
    try:
        os.chmod(target_parent, 448)
    except OSError:
        pass
    ...
    if os.path.exists(target_path):
        ...
        descriptor = os.open(target_path, os.O_WRONLY | os.O_CREAT | os.O_EXCL, 384)
...
def create_app(settings: Settings | None = None, license_transport=None) -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            app_settings.data_dir.mkdir(parents=True, exist_ok=True, mode=448)
            os.chmod(app_settings.data_dir, 448)
            app_settings.user_assets_dir.mkdir(parents=True, exist_ok=True, mode=448)
            os.chmod(app_settings.user_assets_dir, 448)
            app_settings.studio3d_dir.mkdir(parents=True, exist_ok=True, mode=448)
            os.chmod(app_settings.studio3d_dir, 448)
            app_settings.studio3d_exports_dir.mkdir(parents=True, exist_ok=True, mode=448)
            os.chmod(app_settings.studio3d_exports_dir, 448)
            app_settings.effect_variants_dir.mkdir(parents=True, exist_ok=True, mode=448)
            os.chmod(app_settings.effect_variants_dir, 448)
            ...
            os.chmod(app_settings.database_path, 384)
            ...
            app.state.asset_catalog = AssetCatalog(
                app_settings.built_in_assets_dir,
                app_settings.user_assets_dir,
                app_settings.studio3d_exports_dir,
                app_settings.effect_variants_dir,
            )
            ...
            app.state.global_log.append(
                ...
                '系统后台',
                '系统',
                f'HA Bridge {app_settings.version} 已启动',
                context={'phase': 'ready'},
            )
    ...
    async def unhandled_error_response(request: Request, _error: Exception):
        ...
        return PlainTextResponse(
            ...
            status_code=500,
            headers={'X-Request-ID': context['requestId']} if context.get('requestId') else None,
        )
    ...
    async def record_request_diagnostics(request: Request, call_next):
        ...
        diagnostic_path = (
            '/api/hls/[stream]' if request.url.path.startswith('/api/hls/') else request.url.path
        )
        context = {
            'requestId': uuid4().hex,
        ...
        try:
            ...
            if log is not None and api_request and not log_endpoint:
                ...
                if response.status_code >= 400 and not getattr(
                    request.state, 'diagnostic_error_logged', False
                ):
                    log.append(
                        ...
                        details=(
                            ...
                            else json.dumps(detail, ensure_ascii=False) if detail is not None else None
                        ),
                    )
                    ...
                    log.append(
                        ...
                        '系统后台',
                        '性能',
                        f'接口响应缓慢：{request.method} {diagnostic_path} · {context["durationMs"]} 毫秒',
                        context=context,
                    )
            return response
        except Exception as error:
            ...
            if log is not None and not log_endpoint:
                log.append(
                    ...
                    '系统后台',
                    '接口',
                    f'接口运行异常：{request.method} {diagnostic_path} · {error}',
                    context=context,
                    details=traceback.format_exc(),
                )
            raise
    ...
    public_static_files = {
        '/bridge-static/js/auth/pair.js',
        '/bridge-static/css/auth/auth.css',
        '/bridge-static/js/auth/login.js',
        '/bridge-static/js/auth/setup.js',
        ...
        '/bridge-static/assets/brand/ha-bridge-favicon.svg',
        '/bridge-static/assets/brand/ha-bridge-icon-16.png',
        '/bridge-static/assets/brand/ha-bridge-icon-32.png',
        '/bridge-static/assets/brand/ha-bridge-icon-48.png',
        '/bridge-static/assets/brand/ha-bridge-icon-180.png',
        '/bridge-static/assets/brand/ha-bridge-icon-192.png',
        '/bridge-static/assets/brand/ha-bridge-icon-512.png',
        '/bridge-static/assets/manifests/manifest-h3.webmanifest',
        '/bridge-static/assets/manifests/manifest-h4.webmanifest',
        '/bridge-static/assets/manifests/manifest-h5.webmanifest',
        '/bridge-static/assets/brand/ha-bridge-favicon-h3.ico',
        '/bridge-static/assets/brand/ha-bridge-favicon-h3.svg',
        '/bridge-static/assets/brand/ha-bridge-favicon-h4.ico',
        '/bridge-static/assets/brand/ha-bridge-favicon-h4.svg',
        '/bridge-static/assets/brand/ha-bridge-favicon-h5.ico',
        '/bridge-static/assets/brand/ha-bridge-favicon-h5.svg',
        '/bridge-static/assets/brand/ha-bridge-icon-16-h3.png',
        '/bridge-static/assets/brand/ha-bridge-icon-16-h4.png',
        '/bridge-static/assets/brand/ha-bridge-icon-16-h5.png',
        '/bridge-static/assets/brand/ha-bridge-icon-32-h3.png',
        '/bridge-static/assets/brand/ha-bridge-icon-32-h4.png',
        '/bridge-static/assets/brand/ha-bridge-icon-32-h5.png',
        '/bridge-static/assets/brand/ha-bridge-icon-48-h3.png',
        '/bridge-static/assets/brand/ha-bridge-icon-48-h4.png',
        '/bridge-static/assets/brand/ha-bridge-icon-48-h5.png',
        '/bridge-static/assets/brand/ha-bridge-icon-180-h3.png',
        '/bridge-static/assets/brand/ha-bridge-icon-180-h4.png',
        '/bridge-static/assets/brand/ha-bridge-icon-180-h5.png',
        '/bridge-static/assets/brand/ha-bridge-icon-192-h3.png',
        '/bridge-static/assets/brand/ha-bridge-icon-192-h4.png',
        '/bridge-static/assets/brand/ha-bridge-icon-192-h5.png',
        '/bridge-static/assets/brand/ha-bridge-icon-512-h3.png',
        '/bridge-static/assets/brand/ha-bridge-icon-512-h4.png',
        '/bridge-static/assets/brand/ha-bridge-icon-512-h5.png',
        '/bridge-static/assets/brand/ha-bridge-mark-black-orange.svg',
        '/bridge-static/assets/brand/ha-bridge-mark-white-orange.svg',
    }
    ...
    def immutable_private_asset(path: str) -> bool:
        return path.startswith(
            ('/api/v1/assets/effect-variant', '/api/v1/assets/user/', '/api/v1/assets/studio3d-export/')
        )
        ...
        if app_surface:
            ...
            if path.startswith('/api/v1/assets/user/') and response.headers.get('content-type', '').startswith(
                ...
                response.headers['Content-Security-Policy'] = (
                    "default-src 'none'; img-src data:; style-src 'unsafe-inline'; sandbox; frame-ancestors 'none'; base-uri 'none'; form-action 'none'"
                )
    ...
    def favicon() -> FileResponse:
        return FileResponse(
            app_settings.frontend_dir / 'static' / 'assets' / 'brand' / 'ha-bridge-favicon-h5.ico',
    ...
    def apple_touch_icon() -> FileResponse:
        return FileResponse(
            app_settings.frontend_dir / 'static' / 'assets' / 'brand' / 'ha-bridge-icon-180-h5.png',
