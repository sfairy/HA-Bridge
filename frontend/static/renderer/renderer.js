import { popupPlacement } from "../modules/interaction3d/popup-placement.js?v=20260915152715";
import {
  cameraPopupLayout,
  cameraPreviewRatio
...
} from "./registry.js?v=20260915152715";
import { randomUuid } from "../utils/random-id.js?v=20260915152715";
import { popupLayoutMetrics } from "../popup-layout.js?v=20260915152715";
import {
...
} from "./device-profiles.js?v=20260915152715";
import {
  relatedEntityLabel,
...
} from "./entity-power.js?v=20260915152715";
import {
  ICON_VISIBILITY_VIRTUAL_KIND,
  isVirtualEntityId,
  parseVirtualEntityId
} from "../virtual-entities.js?v=20260915152715";
import { componentActionIsSupported } from "../action-rules.js?v=20260915152715";
import {
  airflowCanvasOffsetBounds,
  airflowLayerGeometry,
  groupedComponentLocalDelta,
  rotateMultiSelectionTransforms
} from "./transform-geometry.js?v=20260915152715";
import {
  componentHostZIndex,
  effectCropRectangle,
...
} from "./effect-geometry.js?v=20260915152715";
import {
  ...
  rgbToHsColor
} from "./light-runtime.js?v=20260915152715";
import { entityMetadataIsAvailable } from "./entity-metadata.js?v=20260915152715";
import {
  relatedVacuumBatteryEntity,
  vacuumActionService,
  vacuumBatteryPercent,
  vacuumSupportedActions
} from "./vacuum-runtime.js?v=20260915152715";
import {
  airerDevicePosition,
...
} from "./runtime-caches.js?v=20260915152715";
import {
  collectComponents,
  collectEntityIds,
  lineChartRuntimeStateNeedsHydration,
  syncedLineChartProperties
} from "./runtime-document.js?v=20260915152715";
  ...
  cachedLightVisualState(lightEntityIdInput) {
    ...
    try {
      const storedVisualState = JSON.parse(
        window.localStorage?.getItem("ha-bridge:light-visual:" + lightEntityId) || "null"
      );
      if (
  ...
  rememberLightVisualState(visualEntityIdInput, visualStateUpdate) {
    ...
    try {
      window.localStorage?.setItem(
        "ha-bridge:light-visual:" + visualEntityId,
        JSON.stringify({
          at: Date.now(),
          attributes: cachedAttributes
        })
